...
# This is component 4 - quiz component with randomly generated numbers, equations (x, +), range set to (20) questions, numbers set up to (12)
def quiz():
    # Sets score to 0
    score = 0
    # dictionary
...
# This is component 3 - asks user if they want to continue playing if input is "yes", continue quiz/continue to quiz, if input is "no", ends program
def do_you_continue():
    while True:
...
# This is component 2 - asks user if they want to see instructions and prints instructions is input is "yes", sends user to quiz if "no"
def instructions():
    while True:
...
# This is component 1 - asks user if they've played this quiz before
while True:
